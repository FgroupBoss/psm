...
public class Phase3ReportController {
     ...
     */
    @GetMapping("/summary")
    public ResponseVO<Phase3ReportSummaryVO> summary(@LoginContext UserContext loginContext) {
        return ResponseVO.success(phase3ReportService.summary(loginContext.getTenantId()));
    }
}
